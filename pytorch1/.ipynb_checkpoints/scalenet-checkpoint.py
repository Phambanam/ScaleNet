...
def scalenet152(structure_path, ckpt=None, **kwargs):
    ...
    return model
#model152 = scalenet152(structure_path='../structures/scalenet152.json',ckpt = 'weights/scalenet152.pth')
#model50 = scalenet50(structure_path='../structures/scalenet50.json',ckpt = 'weights/scalenet50.pth')
#model101 = scalenet101(structure_path='../structures/scalenet101.json',ckpt = 'weights/scalenet101.pth')
#model50l = scalenet50(structure_path='../structures/scalenet50_light.json',ckpt = 'weights/scalenet50_light.pth')
